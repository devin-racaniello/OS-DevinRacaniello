...
//
const APP_NAME: string    = "D-TSOS";   // 'cause Bob and I were at a loss for a better name.
const APP_VERSION: string = "0.07001";   // What did you expect?
...
var _MemoryAccesor: TSOS.MemoryAccessor;
